...
import { db, collection, doc, getDoc, setDoc, updateDoc, deleteDoc, writeBatch } from '../firebase';
import { AppBar, Box, Button, Container, Grid, TextField, Toolbar, Typography, Paper, Card, CardActionArea, CardContent, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from "@mui/material";
...
export default function Generate() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            // Handle error appropriately, e.g., by showing an error message to the user
        }
    };
